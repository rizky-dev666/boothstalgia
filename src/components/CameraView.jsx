...
// Komponen sekarang lebih sederhana, tanpa prop atau state terkait GIF
function CameraView({ onNavigate, onCapture, currentPhotos }) {
  ...
  // Logika untuk mengambil foto tunggal (tidak berubah)
  ...
  // Mengosongkan foto yang sudah diambil (tidak berubah)
